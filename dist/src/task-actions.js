...
exports.starknetMigrateAction = exports.starknetPluginVersionAction = exports.starknetRunAction = exports.starknetTestAction = exports.starknetDeployAccountAction = exports.starknetNewAccountAction = exports.starknetVoyagerAction = exports.amarnaAction = exports.starknetDeprecatedCompileAction = exports.starknetCompileCairo1Action = void 0;
...
function getCompilerBinDir(args, config) {
    // give precedence to CLI input over config file
    return (args === null || args === void 0 ? void 0 : args.cairo1BinDir) || config.cairo1BinDir;
}
function starknetCompileCairo1Action(args, hre) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (let sourcesPath of sourcesPaths) {
            ...
            for (const file of files) {
                ...
                {
                    const executed = yield hre.starknetWrapper.compileCairoToSierra({
                        path: file,
                        output: outputPath,
                        binDirPath,
                ...
                {
                    const executed = yield hre.starknetWrapper.compileSierraToCasm({
                        file: outputPath,
                        output: casmOutput,
                        binDirPath,
                ...
                yield recompiler.updateCache(args, file, outputPath, abiOutput);
            }
...
function starknetDeprecatedCompileAction(args, hre) {
    return __awaiter(this, void 0, void 0, function* () {
        const root = hre.config.paths.root;
        const rootRegex = new RegExp("^" + root);
        const defaultSourcesPath = hre.config.paths.starknetSources;
        ...
        for (let sourcesPath of sourcesPaths) {
            ...
            for (const file of files) {
                ...
                const executed = yield hre.starknetWrapper.deprecatedCompile({
                    file,
                    output: outputPath,
                    abi: abiPath,
                    cairoPath,
...
function starknetMigrateAction(args, hre) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (let file of files) {
            file = (0, utils_1.adaptPath)(root, file);
