...
(0, config_1.extendEnvironment)((hre) => {
    ...
    if (venvPath) {
        ...
        if (hre.config.starknet.cairo1BinDir) {
            throw new starknet_plugin_error_1.StarknetPluginError(`cairo1BinDir cannot be used with dockerized plugin.
Remove cairo1BinDir to use the default dockerized cairo1 compiler OR specify a local venv.`);
        }
    }
});
(0, config_1.task)("starknet-compile-deprecated", "Compiles Starknet contracts")
...
(0, config_1.task)("starknet-compile", "Compiles Starknet cairo1 contracts")
    .addOptionalVariadicPositionalParam("paths", "The paths are source files of contracts to be compiled.\n" +
    "Each of the provided paths is recursively looked into while searching for compilation artifacts.\n" +
    "If no paths are provided, the default contracts directory is traversed.")
    .addOptionalParam("cairo1BinDir", "Allows to specify locally installed cairo1 compiler directory.\n" +
