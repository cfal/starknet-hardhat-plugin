...
function createIntegratedDevnet(hre) {
    ...
    if (devnetNetwork.venv) {
        return new venv_devnet_1.VenvDevnet(devnetNetwork.venv, hostname, port, devnetNetwork === null || devnetNetwork === void 0 ? void 0 : devnetNetwork.args, devnetNetwork === null || devnetNetwork === void 0 ? void 0 : devnetNetwork.stdout, devnetNetwork === null || devnetNetwork === void 0 ? void 0 : devnetNetwork.stderr, devnetNetwork.vmLang);
    }
    ...
    return new docker_devnet_1.DockerDevnet({
        ...
        tag
    }, hostname, port, devnetNetwork === null || devnetNetwork === void 0 ? void 0 : devnetNetwork.args, devnetNetwork === null || devnetNetwork === void 0 ? void 0 : devnetNetwork.stdout, devnetNetwork === null || devnetNetwork === void 0 ? void 0 : devnetNetwork.stderr, devnetNetwork.vmLang);
}
