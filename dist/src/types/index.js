...
class StarknetContractFactory {
    ...
    resolveContructorPredicate() {
        ...
        if ((casmJson === null || casmJson === void 0 ? void 0 : casmJson.compiler_version.split(".")[0]) !== "1") {
            const msg = ".CASM json has to contain compiler_version '1.*.*'";
            throw new starknet_plugin_error_1.StarknetPluginError(msg);
        }
        if (!((_a = casmJson === null || casmJson === void 0 ? void 0 : casmJson.entry_points_by_type) === null || _a === void 0 ? void 0 : _a.CONSTRUCTOR)) {
        ...
        return (abiEntry) => {
            return starknet_1.hash.getSelectorFromName(abiEntry.name) === selector;
        };
    }
    /**
    ...
    declare(options = {}) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            const executed = yield this.hre.starknetWrapper.declare({
                ...
                nonce: (_a = options.nonce) === null || _a === void 0 ? void 0 : _a.toString()
            });
            if (executed.statusCode) {
    ...
    getClassHash() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.classHash =
                (_a = this.classHash) !== null && _a !== void 0 ? _a : (yield this.hre.starknetWrapper[method](this.metadataPath));
...
class StarknetContract {
    ...
    interact(choice, functionName, args, options = {}) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const abi = this.abiPath && !fs.readFileSync(this.abiPath, "utf8").includes("core::")
                ? this.abiPath
                : undefined;
     ...
     */
    estimateMessageFee(functionName, args) {
        return __awaiter(this, void 0, void 0, function* () {
            // Check if functionName is annotated with @l1_handler
            const func = this.abi[functionName];
            if (!(func === null || func === void 0 ? void 0 : func.type) || func.type.toString() !== "l1_handler") {
    ...
    decodeEvents(events) {
        ...
        for (const event of events) {
            ...
            const adapted = (0, adapt_1.adaptOutputUtil)(rawEventData, inputSpecs, this.abi);
...
class Cairo1ContractClass extends StarknetContract {
    ...
    getFormattedAbi() {
        ...
        return (0, utils_1.formatSpaces)(JSON.stringify(abiArr));
    }
}
